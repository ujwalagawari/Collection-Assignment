 ...
 * @author ugawari
 *
 * Class to create object of CellPhone and having properties company, model, description, operatingSstem, price 
 */
public class CellPhone {
	...
	/**
	 * Creating hash code based on company name and Operating System
	 */
	@Override
	public int hashCode() {
		final int prime = 31;
